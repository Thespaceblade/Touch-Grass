...
struct ManhuntBubbleSettingsView: View {
    ...
    init(startRadius: Binding<Double>, duration: Binding<Double>, hunterCount: Binding<Int>, onStart: @escaping (CLLocationCoordinate2D) -> Void, userLocation: CLLocationCoordinate2D?, maxPlayers: Int) {
                ...
                ScrollView {
                    VStack(spacing: AppSpacing.xl) {
                        ...
                        VStack(alignment: .leading, spacing: AppSpacing.lg) {
                            ...
                            // Hunter Count (for Hunter Tag)
                            VStack(alignment: .leading, spacing: AppSpacing.sm) {
                                HStack {
                                    Text("Number of Initial Hunters")
                                        .font(AppTypography.labelLarge())
                                        .fontWeight(.semibold)
                                        .foregroundColor(AppColors.textPrimary)
                                    Spacer()
                                ...
                                // Only show slider if we have a valid range (maxHunterCount > 1)
                                ...
                                if canShowHunterSlider {
                                    ...
                                    // If only 1 player, just show the value (can't have more than 1 hunter with 1 player)
